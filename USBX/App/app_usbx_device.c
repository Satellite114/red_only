...
UINT MX_USBX_Device_Init(VOID *memory_ptr)
{
  ...
  /* Debug: Check if memory_ptr is valid */
  if (memory_ptr == NULL)
  {
    return UX_ERROR;
  }
  ...
  /* Debug checkpoint 1: Memory allocation successful */
  ...
  /* Debug checkpoint 2: USBX system initialization successful */

  /* Get Device Framework High Speed and get the length */
  device_framework_high_speed = USBD_Get_Device_Framework_Speed(USBD_HIGH_SPEED,
                                                                &device_framework_hs_length);

  /* Debug checkpoint 3: High speed framework obtained */

  /* Get Device Framework Full Speed and get the length */
  device_framework_full_speed = USBD_Get_Device_Framework_Speed(USBD_FULL_SPEED,
                                                                &device_framework_fs_length);

  /* Debug checkpoint 4: Full speed framework obtained */
  ...
  /* Debug checkpoint 5: All frameworks obtained */

  /* Debug: Check if all frameworks are valid */
  if (device_framework_high_speed == NULL || device_framework_full_speed == NULL ||
      string_framework == NULL || language_id_framework == NULL)
  {
    /* Framework pointers are NULL - initialization will fail */
    return UX_ERROR;
  }
  
  /* Debug: Check if lengths are valid */
  if (device_framework_hs_length == 0 || device_framework_fs_length == 0 ||
      string_framework_length == 0 || language_id_framework_length == 0)
  {
    /* Framework lengths are zero - initialization will fail */
    return UX_ERROR;
  }
