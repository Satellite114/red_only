...
// --- Keil/IAR printf compatibility for libirtemp.lib ---
/**
 * @brief Keil/IAR printf compatibility function.
 *        This function is required by libirtemp.lib which was compiled with Keil/IAR compiler.
 *        It redirects __2printf calls to standard printf.
 * @param format Format string (same as printf).
 * @param ... Variable arguments.
 * @retval int Number of characters printed.
 */
int __2printf(const char *format, ...)
{
  va_list args;
  int result;
